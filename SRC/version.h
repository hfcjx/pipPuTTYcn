 ...
 */
//PuTTYAttach
//#define TEXTVER "发布版 0.81-p23-cn1 (便携版 0.23)"
#define TEXTVER "(pipPuTTY)发布版 0.81-p23-cn1 (便携版 0.23)"
//
#define SSHVER "-Release-0-81-Patch23-CN1"
#define BINARY_VERSION 0,81,23,1
